...
Meteor.startup(() => {
  ...
  if (Seals.find().count() === 0) {
    ...
    insertSeal({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/seal1.jpeg", "../images/seed/seal1b.jpeg", "../images/seed/seal1c.jpeg"],
      xIsland: "Oahu",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
    ...
    insertSeal({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/seal3.jpeg"],
      xIsland: "Oahu",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
    ...
    insertSeal({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/seal4.jpeg"],
      xIsland: "Oahu",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
  ...
  if (Turtles.find().count() === 0) {
    ...
    insertTurtle({
      ...
      xAmpFlipper: "N",
      xWhichFlipper: "",
      xImages: ["../images/seed/turtle1.webp"],
    ...
    insertTurtle({
      ...
      xAmpFlipper: "N",
      xWhichFlipper: "",
      xImages: ["../images/seed/turtle2.jpeg"],
      MainIdentification: "S",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
    ...
    insertTurtle({
      ...
      xAmpFlipper: "Y",
      xWhichFlipper: "Left",
      xImages: ["../images/seed/turtle3.jpg"],
      MainIdentification: "S",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
    ...
    insertTurtle({
      ...
      xAmpFlipper: "Y",
      xWhichFlipper: "Left",
      xImages: ["../images/seed/turtle4.jpeg"],
      MainIdentification: "S",
      xSightings: 1,
      xRelated: "",
      xConfirmRelated: "",
  ...
  if (Birds.find().count() === 0) {
    ...
    insertBird({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/birdLAAL1.jpeg"],
      MainIdentification: "T",
      xSightings: 1,
      xRelated: "",
      xIsland: "Oahu",
    ...
    insertBird({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/birdBRBO1.jpeg"],
      MainIdentification: "T",
      xSightings: 1,
      xRelated: "",
      xIsland: "Oahu",
    ...
    insertBird({
      ...
      xScarsYN: "N",
      xScarsLocation: "",
      xImages: ["../images/seed/birdBRBO2.jpeg"],
      MainIdentification: "T",
      xSightings: 1,
      xRelated: "",
      xIsland: "Oahu",
